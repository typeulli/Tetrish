...
namespace core {
    ...
    public:
        ...
        [[nodiscard]] BlocksMask mask(int leftX, int lowerY) const;

        [[nodiscard]] Collider harddrop(int leftX, int lowerY) const;
    ...
    public:
        ...
        [[nodiscard]] const Piece &get(PieceType piece) const;

        [[nodiscard]] const Blocks &get(PieceType piece, RotateType rotate) const;
